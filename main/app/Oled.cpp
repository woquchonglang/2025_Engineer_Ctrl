...
void oled_init() {
  ...
  ESP_LOGI(TAG, "i2c_0 config done");
  i2c_driver_install(I2C_NUM_0, I2C_MODE_MASTER, 0, 0, 0);
  ESP_LOGI(TAG, "i2c_0 install done");

  dev = ssd1306_create(I2C_NUM_0, SSD1306_I2C_ADDRESS);
...
void oled_task() {
  ...
  u8g2_Setup_ssd1306_i2c_128x64_noname_f(&u8g2, U8G2_R0, u8x8_byte_i2c,
                                         u8x8_gpio_and_delay);
